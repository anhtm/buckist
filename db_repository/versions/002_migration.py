...
user = Table('user', post_meta,
    ...
    Column('pwhash', String(length=54)),
)
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['list'].columns['user_id'].create()
    ...
    post_meta.tables['user'].columns['pwhash'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['list'].columns['user_id'].drop()
    ...
    post_meta.tables['user'].columns['pwhash'].drop()
